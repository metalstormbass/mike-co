...
<head>
    ...
    <title>OS Vulnerabilities</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>🔴 OS Vulnerabilities</h1>
            <p class="subtitle">Operating System Component Vulnerabilities</p>
        </div>
    ...
    <script>
        ...
        async function loadVulnerabilities() {
            try {
                    ...
                    try {
                        ...
                        if (scanResults.matches) {
                            scanResults.matches.forEach(match => {
                                ...
                                // Only include OS package vulnerabilities
                                const packageType = artifact.type || '';
                                if (['deb', 'rpm', 'apk'].includes(packageType)) {
                ...
                console.log('Total OS vulnerabilities found:', vulnerabilities.length);
                    ...
                    <div class="vuln-content">
                        <div class="vuln-body">
                            <div class="vuln-section">
                                ...
                                <div class="vuln-section-content code-block">${v.package} @ ${v.version}</div>
                            </div>
